...
import static com.siit.picassoutil.Utils.parseResponseSourceHeader;
...
public class UrlConnectionDownloader implements Downloader {
  ...
  private static class ResponseCacheIcs {
    static Object install(Context context) throws IOException {
      ...
      HttpResponseCache cache = HttpResponseCache.getInstalled();// Android支持com.android.okhttp.HttpResponseCache即是okhttp请求
      if (cache == null) {
