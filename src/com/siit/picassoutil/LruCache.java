...
public class LruCache implements Cache {
  final LinkedHashMap<String, Bitmap> map;// 链表
  ...
  public LruCache(Context context) {
    this(Utils.calculateMemoryCacheSize(context));// 计算内存缓存支持的大小
  }
  ...
  public LruCache(int maxSize) {
    ...
    this.map = new LinkedHashMap<String, Bitmap>(0, 0.75f, true);//线程安全
  }
