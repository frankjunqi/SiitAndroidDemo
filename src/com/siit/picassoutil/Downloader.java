...
/** A mechanism to load images from external resources such as a disk cache and/or the internet. 一种机制来从外部资源,如磁盘缓存加载图像和/或互联网。*/
public interface Downloader {
  ...
  /** Response stream or bitmap and info. 响应流或位图和信息。*/
  class Response {
