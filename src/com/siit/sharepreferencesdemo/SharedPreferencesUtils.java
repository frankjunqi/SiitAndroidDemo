...
import com.siit.util.PicassoApplication;
 ...
 * @author
 * 
 *         2014-09-25 SharedPreference统一用此工具类 kjh
 */
public class SharedPreferencesUtils {
	...
	private SharedPreferencesUtils() {
		sharedPreferences = PicassoApplication
				.getInstance()
				.getApplicationContext()
				.getSharedPreferences(SharedPreferencesKeys.PREFERENCES_NAME,
	...
	public Boolean getBoolean(String name, boolean defaultValue) {
		...
		if (softRef == null
				|| (softRef != null && TextUtils.isEmpty(softRef.get()))) {
			boolean value = sharedPreferences.getBoolean(name, defaultValue);
			prefCache.put(name,
					new SoftReference<String>(String.valueOf(value)));
		}
